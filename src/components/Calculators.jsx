...
export default function Calculators() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-6 py-4 sm:py-6 space-y-6 sm:space-y-8 bg-black">
      
      {/* Top Banner */}
      <div className="glass-panel p-4 sm:p-6 rounded-2xl border border-amber-500/20 bg-gradient-to-r from-amber-500/10 via-zinc-950 to-black">
      ...
      <div className="glass-panel p-4 sm:p-6 rounded-2xl border border-zinc-800/80 space-y-4 sm:space-y-6">
        <div className="flex items-center justify-between">
          <label className="text-xs sm:text-sm font-semibold uppercase tracking-wider text-zinc-400 flex items-center space-x-2">
          ...
          {[20, 30, 40, 50, 60].map(speed => (
            <button
              ...
              className={`min-h-[52px] sm:min-h-[64px] p-2 sm:p-4 rounded-xl font-bold text-center transition-all flex flex-col items-center justify-center space-y-0.5 ${
                speedLimit === speed
                  ? 'bg-gradient-to-b from-amber-400 to-amber-500 text-black shadow-lg shadow-amber-500/25 scale-[1.02]'
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4">
        ...
        <div className="glass-card p-4 sm:p-5 rounded-2xl border border-zinc-800/80 space-y-1.5 bg-zinc-950/80">
      ...
      <div className="glass-panel p-4 sm:p-6 rounded-2xl border border-zinc-800/80 space-y-3.5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="bg-zinc-950 p-3.5 rounded-xl border border-zinc-800">
            <span className="text-[11px] text-zinc-400">Recommended Warning Sign Size</span>
            <div className="text-base font-bold text-zinc-200 mt-0.5">{safetyResults.recommendedSignSize}</div>
          </div>
          <div className="bg-zinc-950 p-3.5 rounded-xl border border-zinc-800">
            <span className="text-[11px] text-zinc-400">Clear Visibility Distance</span>
            <div className="text-base font-bold text-zinc-200 mt-0.5">{safetyResults.clearVisibilityDistance}</div>
          </div>
          <div className="bg-zinc-950 p-3.5 rounded-xl border border-zinc-800">
            <span className="text-[11px] text-zinc-400">Passing Lane Minimum Width</span>
            <div className="text-base font-bold text-zinc-200 mt-0.5">{safetyResults.minimumPassingLaneWidth}</div>
          </div>
        </div>
      </div>

      {/* Traffic Control Evaluator */}
      <div className="glass-panel p-4 sm:p-6 rounded-2xl border border-zinc-800/80 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-zinc-950 p-4 rounded-xl border border-zinc-800">
          <div>
            ...
            <input
              ...
              className="w-full accent-amber-500 cursor-pointer h-2 bg-zinc-900 rounded-lg"
            />
          </div>

          <div className="flex items-center justify-between pt-1 sm:pt-0">
            <label className="text-xs sm:text-sm font-semibold text-zinc-300">Clear Visibility to Both Ends?</label>
            <button
            ...
            >
              ...
              <div className="flex-1 space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  {tc.badge && (
                    <span className="px-2 py-0.5 bg-zinc-900 text-amber-400 text-[10px] sm:text-xs rounded-full font-medium border border-zinc-800">
                      {tc.badge}
                    </span>
                  )}
                </div>
          ...
          <div>
            ...
            <div className="flex items-center space-x-3">
              <input
                ...
                className="w-28 sm:w-32 bg-zinc-950 border border-zinc-800 text-white font-bold text-base sm:text-lg rounded-xl px-3.5 py-2 focus:outline-none focus:border-amber-500 min-h-[44px]"
              />
              <span className="text-sm font-semibold text-zinc-400">metres</span>
            </div>
          </div>
